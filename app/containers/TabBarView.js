...
const tabBarItems = [
    { title: '首页', icon: () => <Image style={{ width: 15, height: 15 }} source={{uri:'item-cook.png'}}/>, component: RecipesContainers },
    { title: '客服', icon: () => <Image style={{ width: 15, height: 15 }} source={{uri:'face.png'}}/>, component: AnswersContainers },
    { title: '购物车', icon: () => <Image style={{ width: 15, height: 15 }} source={{uri:'love.png'}}/>, component: CollectContainer },
    { title: '我的', icon: () => <Image style={{ width: 15, height: 15 }} source={{uri:'slim.png'}}/>, component: MoreContainer },
]
