            ...
            <View style = {{backgroundColor: 'rgb(255, 250, 207)'}}>
                <HeaderView titleView= {'个人中心'}/>
                {
                    <ListView
                        ...
                        initialListSize= {10}
                        style={{ height: Common.window.height-110, paddingLeft: 10, paddingRight: 10, paddingTop: 30, paddingBottom: 50, borderRadius: 10}}//减去导航的高度
                        />
                }
            </View>
        );
 ...
 // }
    ...
    renderRow(rowDate,sectionID: number | string, rowID: number | string,) {
        return (
            <TouchableOpacity
                activeOpacity={0.75}
                onPress={() =>this._onPressFeedItem(rowDate, rowID) }
                style={styles.center}
                >
